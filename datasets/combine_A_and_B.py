...
parser.add_argument('--fold_A', dest='fold_A', help='input directory for image A', type=str,
                    default='/media/test/Samhi/GANILLA/image_colorization/dataset/ade20k_hed_pair/')
...
parser.add_argument('--fold_AB', dest='fold_AB', help='output directory', type=str,
                    default='/media/test/Samhi/GANILLA/image_colorization/dataset/ade20k_hed_pair/train_AB')
